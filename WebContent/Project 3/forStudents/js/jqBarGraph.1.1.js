...
(function($) {
	...
	doGraph = function(el){
		...
		fieldWidth = ($(el).width()-(legendWidth+20))/data.length; //width of bar
		...
		if (typeof max === "undefined") {
			...
			if (parseFloat(max) < parseFloat(getMax(data))) { 
				alert('bigger Max!' + getMax(data)	);
			}
		}
